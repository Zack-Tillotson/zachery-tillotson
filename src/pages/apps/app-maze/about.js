...
const MazeContainer = () => (
  <Layout title="Maze Maker">
    <section className="app-layout__content">
      ...
      <section>
        <h4>Is this a "real" maze? Like everything is connected?</h4>
      ...
      <section>
        <h4>What does it mean to say the algorithm is "stochastic"?</h4>
        <p>The word stochastic describes something that was randomly determined. In this case it refers to the algorithm randomly choosing which rooms to connect and it's what causes the maze to be different every time. Reference: <a href="https://en.wikipedia.org/wiki/Stochastic">Wikipedia</a></p>
      </section>
      <section>
        <h4>Are there other ways to make a maze?</h4>
